    ...
    return (
      <div className={`relative inline-block ${className}`} ref={dropdownRef}>
        ...
        >
          ...
          <span className="font-bold text-[11px]">{currentSource.label.split(' ')[0]}</span>
          <span className="text-[9px] font-mono px-1 py-0.2 rounded bg-black/40 text-zinc-300 border border-white/10 uppercase">
        ...
        {isOpen && (
          <div className="absolute right-0 mt-2 w-72 p-2 bg-zinc-950/95 backdrop-blur-2xl border border-zinc-800 rounded-2xl shadow-2xl z-50 animate-in fade-in slide-in-from-top-2 duration-150">
            <div className="px-3 py-1.5 mb-1 border-b border-zinc-850 flex items-center justify-between">
              <span className="text-[11px] font-bold uppercase tracking-wider text-zinc-400">
                Anime Data Source
              </span>
              <span className="text-[10px] text-zinc-500 font-mono">GraphQL / REST</span>
            </div>
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-start gap-2.5 p-2 rounded-xl text-left transition-all cursor-pointer ${
                      isSelected
                        ? 'bg-zinc-850/90 border border-zinc-700/60 shadow-sm'
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-[9px] px-1 py-0.2 rounded font-mono bg-zinc-800 text-zinc-300">
                          {item.badge}
                        </span>
                      </div>
          ...
          return (
            <button
              ...
              className={`p-3 rounded-2xl border text-left flex flex-col justify-between transition-all cursor-pointer ${
                isSelected
                  ? 'bg-zinc-900 border-orange-500/50 shadow-md ring-1 ring-orange-500/30'
            ...
            >
              <div className="flex items-center justify-between w-full mb-1.5">
                ...
                {isSelected ? (
                  ...
                  <span className="text-[9px] font-mono text-zinc-500">{item.badge}</span>
                )}
              </div>
