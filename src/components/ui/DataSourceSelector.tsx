     ...
     return (
      <button
       ...
       className={`p-3 rounded-2xl border text-left flex flex-col justify-between transition-all cursor-pointer ${
        isSelected
         ? 'bg-surface-canvas border-orange-500/50 shadow-md ring-1 '
         : 'bg-surface-canvas/60 border-ink-700 hover:bg-surface-canvas/60 hover:border-border-subtle'
       }`}
      >
       <div className="flex items-center justify-between w-full mb-1.5">
        ...
        {isSelected ? (
         ...
         <span className="text-xs font-mono text-ink-500">{item.badge}</span>
        )}
       </div>
