...
export const Footer: React.FC = () => {
 return (
  <footer className="w-full border-t border-ink-700/80 bg-surface-canvas text-ink-500 py-12 mt-20">
   <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
     <div className="md:col-span-2 space-y-3">
      <div className="flex items-center gap-2">
       <div className="w-7 h-7 rounded-lg bg-orange-600 flex items-center justify-center shadow-md ">
     ...
     <div>
      <h4 className="text-xs font-semibold uppercase tracking-wider text-ink-300 mb-3 font-mono">
       Quick Navigation
      </h4>
     ...
     <div>
      ...
      <ul className="space-y-2 text-sm">
       <li className="flex items-center gap-1.5">
        ...
        >
         Jikan API (MyAnimeList) <ExternalLink className="w-3 h-3 text-ink-500" />
        </a>
       </li>
       <li className="flex items-center gap-1.5">
        <a
         ...
         className="hover:text-orange-400 transition-colors flex items-center gap-1"
        >
         MegaPlay Streams <ExternalLink className="w-3 h-3 text-ink-500" />
        </a>
       </li>
       <li className="flex items-center gap-1.5 text-ink-500 text-xs mt-2">
