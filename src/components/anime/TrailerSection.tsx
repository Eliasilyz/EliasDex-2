...
export const TrailerSection: React.FC<TrailerSectionProps> = ({
 ...
 return (
  <div className="space-y-4">
   {/* Video Container */}
   <div className="relative w-full aspect-video rounded-2xl sm:rounded-3xl overflow-hidden bg-black border border-ink-700 shadow-2xl group">
    {isPlaying && embedUrl ? (
     <iframe
     ...
     <div className="relative w-full h-full">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
       <button
        ...
        className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-orange-500 hover:bg-orange-400 text-white flex items-center justify-center shadow-xl  active:scale-95 transition-all duration-200 cursor-pointer group/btn"
