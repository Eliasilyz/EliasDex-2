      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-zinc-400">Discover and search from thousands of anime series and movies</p>
          </div>
        ...
        <form onSubmit={handleSearchSubmit} className="relative flex items-center">
          ...
          <input
            ...
            className="w-full bg-zinc-900 border border-zinc-800 rounded-2xl pl-12 pr-36 py-3.5 text-sm text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20"
          />
        ...
        <div className="flex items-center gap-2 overflow-x-auto no-scrollbar py-1 text-xs">
          <span className="text-zinc-500 shrink-0 flex items-center gap-1 text-[11px] font-medium">
        ...
        {showFilters && (
          <div className="p-5 rounded-2xl bg-zinc-900/80 border border-zinc-800 space-y-4 animate-in fade-in duration-150">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 text-xs">
              {/* Genre */}
              <div className="space-y-1.5">
                <label className="text-zinc-400 font-medium">Genre</label>
                <select
                  value={selectedGenre}
                  onChange={(e) => {
                  ...
                  className="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-3 py-2 text-zinc-200 focus:outline-none focus:border-orange-500 cursor-pointer"
                >
