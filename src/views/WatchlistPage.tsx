    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3.5 sm:gap-4 lg:gap-5">
     {filteredItems.map((item) => {
      ...
      return (
       <div
        key={item.malId}
        className="group relative flex flex-col h-full rounded-2xl bg-surface-canvas/50 border border-ink-700/80 hover:border-orange-500/50 hover:shadow-xl hover: transition-all duration-300 overflow-hidden"
       >
        {/* Poster */}
        <div
        ...
        >
         ...
         <div className="absolute top-2.5 left-2.5 z-10 pointer-events-none">
          <span className="inline-flex items-center px-2 py-0.5 rounded-md text-xs font-mono uppercase font-bold tracking-wider bg-surface-canvas/80 backdrop-blur-md text-orange-300 border border-orange-500/30">
         ...
         {item.score && (
          <div className="absolute top-2.5 right-2.5 z-10 pointer-events-none">
           <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-xs font-bold bg-surface-canvas/80 backdrop-blur-md text-amber-400 border border-white/10">
